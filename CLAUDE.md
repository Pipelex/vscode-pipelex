...
- Grammar defined in `editors/vscode/mthds.tmLanguage.json`
- Semantic tokens: mthdsConcept, mthdsPipeType, mthdsDataVariable, mthdsPipeName, mthdsPipeSection, mthdsConceptSection
