// Adapted from crates/taplo-wasm/src/lsp.rs
// Uses MthdsEnvironment<WasmEnvironment> instead of raw WasmEnvironment.
...
#[wasm_bindgen]
pub struct PipelexWasmLsp {
    pub(crate) server: Server<Arc<WorldState<MthdsEnvironment<WasmEnvironment>>>>,
    pub(crate) world: Arc<WorldState<MthdsEnvironment<WasmEnvironment>>>,
...
impl Sink<rpc::Message> for WasmLspInterface {
    ...
    fn start_send(
        ...
        self.js_on_message.call1(&this, &js_value).unwrap();
        Ok(())
    }
