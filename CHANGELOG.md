...
### Added
 ...
 - **Documentation**: Added `docs/dev/mthds-engine-bindings.md` describing the multi-binding engine (plxt CLI / `pipelex-tools-py` / `@pipelex/lsp` / `@pipelex/tools-wasm` — one impl, several bindings, parity by construction).
